...
public class Main {
  ...
  private static void sol(List<Rectangle> rects) {
    rects.sort((o1, o2) -> Double.compare(o2.getHeight(), o1.getHeight()));
    int height = (int) rects.get(0).getHeight();

    Draw draw = new Draw();
    EnclosingRectangle enclosingRectangle = new EnclosingRectangle(draw);
    rects.sort((o1, o2) -> Double.compare(o2.getHeight(), o1.getHeight()));
    int maxHeight = (int) rects.get(0).getHeight();

    // enclosingRectangle.solve(rects, maxHeight, 100);

    Solution bestSol = enclosingRectangle.solve(rects, maxHeight, 2000);
...
//    List<List<Rectangle>> poss = new ArrayList<>();
//    for (Rectangle rect : rects) {
//      List<Rectangle> rectangleList = new ArrayList<>();
//      rectangleList.add(rect);
//      rectangleList.add(new Rectangle(rect.x, rect.y,rect.height, rect.width ));
//      poss.add(rectangleList);
//    }
//
